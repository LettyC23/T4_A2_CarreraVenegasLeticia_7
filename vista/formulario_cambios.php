           ...
           <?php
              ...
              if(mysqli_num_rows($res)>0){
                  ...
                  while($fila=mysqli_fetch_assoc($res)){
                            ...
                            "<td>".$fila['Semestre']."</td>".
                            "<td>".$fila['Carrera']."</td>".
                                   "<td> <a href='../vista/formulario_cambios.php?nc=%s&n=%s&pa=%s&sa=%s&e=%s&s=%s&c=%s'>MODIFICAR</a> </td> </tr>", $fila['Num_Control'],$fila['Nombre_Alumno'],$fila['Primer_Ap_Alumno'],$fila['Segundo_Ap_Alumno'],$fila['Edad'],$fila['Semestre'],$fila['Carrera']         
